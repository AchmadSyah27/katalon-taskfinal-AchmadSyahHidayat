...
WebUI.sendKeys(findTestObject('Website/Automation_Excercise/Page_LoginRegister/textbox_emailUsername'), IncorrectUsername)

'Melakukan input password'
WebUI.sendKeys(findTestObject('Website/Automation_Excercise/Page_LoginRegister/textbox_password'), password)
