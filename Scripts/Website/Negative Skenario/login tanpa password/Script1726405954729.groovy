...
WebUI.sendKeys(findTestObject('Website/Page_Login/textbox_email'), findTestData('DataTest').getValue(2, 3))

'Menginput password dari data test file excel'
WebUI.sendKeys(findTestObject('Website/Page_Login/textbox_password'), findTestData('DataTest').getValue(3, 3))

'Memastikan button login tidak dapat di klik'
WebUI.verifyElementNotClickable(findTestObject('Website/Page_Login/button_login'))

'Melakukan screenshot halaman login tanpa password'
WebUI.takeScreenshot('Screenshot/Website/loginTanpaPassword.png')
