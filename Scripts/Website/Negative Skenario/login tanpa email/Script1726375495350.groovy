...
WebUI.sendKeys(findTestObject('Website/Page_Login/textbox_email'), findTestData('DataTest').getValue(2, 1))

'Menginput password dari data test file excel'
WebUI.sendKeys(findTestObject('Website/Page_Login/textbox_password'), findTestData('DataTest').getValue(3, 1))
...
'Melakukan screenshot halaman login tanpa email'
WebUI.takeScreenshot('Screenshot/Website/loginTanpaEmail.png')
